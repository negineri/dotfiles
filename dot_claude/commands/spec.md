...
# 3. 段階的対話を通じた仕様の精緻化
# 4. 3 つの独立したファイルを生成:
#    - ./docs/specs/YYYY-MM-DD_spec名/requirements.md: EARS 記法による要件定義
#    - ./docs/specs/YYYY-MM-DD_spec名/design.md: Mermaid 図・ インターフェース含む設計
#    - ./docs/specs/YYYY-MM-DD_spec名/tasks.md: ベストプラクティス自動適用の実装計画
```
